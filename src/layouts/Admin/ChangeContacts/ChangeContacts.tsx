...
class ChangeContacts extends Component<ChangeContactsProps, ChangeContactsState> {
    ...
    private formSubmitHandler = () => {
        database.ref().child('contacts').update(this.state.newContacts);
    }
    ...
    public render() {
        ...
        const formContent = <div className="FormContent">
            <div className="form-control">
                ...
                />
                <p className="current">{current}{this.state.currentContacts.en.address}</p>
                <p>adress (UA): </p>
                <br />
                <input
                    type="text"
                ...
                />
                <p className="current">{current}{this.state.currentContacts.ua.address}</p>
                <p>postCode: </p>
                <br />
                <input
                    type="text"
                ...
                />
                <p className="current">{current}{this.state.currentContacts.postCode}</p>
                <p>phone: </p>
                <br />
                <input
                    type="text"
                ...
                />
                <p className="current">{current}{this.state.currentContacts.phone}</p>
                <p>email: </p>
                <br />
                <input
                    type="text"
                ...
                />
                <p className="current">{current}{this.state.currentContacts.email}</p>
            </div>
        ...
        return (
            <AppContext.Consumer>
                {value => <form onSubmit={this.formSubmitHandler} className="ContactsForm form">
