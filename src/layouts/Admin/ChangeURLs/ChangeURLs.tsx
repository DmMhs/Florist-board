...
class ChangeURLs extends Component<ChangeURLsProps, ChangeURLsState> {
    ...
    public componentDidMount() {
        database.ref().child('urls').on('value', snapshot => {
            this.setState({
    ...
    private formSubmitHandler = () => {
        database.ref().child('urls').update(this.state.newURLs);
    }
    ...
    public render() {
        ...
        const formContent = <div className="FormContent">
            <div className="form-control">
                ...
                />
                <p className="current">{current}{this.state.currentURLs.en_flag}</p>
                <p>ua_flag:</p>
                <br />
                <input
                    type="text"
                ...
                />
                <p className="current">{current}{this.state.currentURLs.ua_flag}</p>
                ...
                />
                <p className="current">{current}{this.state.currentURLs.google_map_address}</p>
                ...
                />
                <p className="current">{current}{this.state.currentURLs.socials.instagram}</p>
                ...
                />
                <p className="current">{current}{this.state.currentURLs.socials.facebook}</p>
                ...
                />
                <p className="current">{current}{this.state.currentURLs.socials.telegram}</p>
            </div>
        ...
        return (
            <AppContext.Consumer>
                {value => <form onSubmit={this.formSubmitHandler} className="URLsForm form">
              {this.state.fetchInProgress === true ? <Spinner /> : formContent}</form>}
            </AppContext.Consumer>
        )
    }
}
